...
public class Application extends android.app.Application {
    ...
    public void onCreate() {
        ...
        Parse.initialize(this, "LJRnWqJwuGZR90GWBzQqzliHOoKYtjQGkqdsLbJy", "ktD2GOJRcfJZYbxijuHyPvqHmHZx94dDTFTjfvhT");
        ParseObject.registerSubclass(UserReview.class);
        ParseObject.registerSubclass(ShouldWeVenue.class);
